...
final class Version20250322143653 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, login VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(30) NOT NULL, lastname VARCHAR(40) NOT NULL, avatar LONGBLOB DEFAULT NULL, email VARCHAR(100) NOT NULL, dtype VARCHAR(255) NOT NULL, pathologie VARCHAR(100) DEFAULT NULL, specialite VARCHAR(40) DEFAULT NULL, type_admin VARCHAR(20) DEFAULT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_LOGIN (login), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
